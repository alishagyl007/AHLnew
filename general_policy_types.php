...
<div class="asidebar">
    <div class="inner_section">
        <div class="row">
            <div class="col-md-12">
                <h3 class="page_title">General Policy Types</h3>
            </div>
            <div class="col-md-6">
                <div class="whitebg">
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <?php
                            $school_sql = mysql_query("select * from `policy_type` order by id desc");
                ...
                <div class="whitebg">
                    <form method="post">
                        <div class="form-group">
                            ...
                            <hr>
                            <input type="text" name="add_school_name" class="form-control" placeholder="Enter Type" required>
                        </div>
                        <div class="text-left">
                            <button type="submit" name="sbt" class="btn btn-danger">Add Type</button>
                        </div>
                    </form>
                </div>
            </div>
...
if(isset($_REQUEST['sbt'])){
    ...
    mysql_query("INSERT INTO `policy_type`(`name`) VALUES ('".$add_school_name."')");
    echo "<script>alert('Type Added');</script>";
    header('Location: general_policy_types.php');
}
?>
